...
func (s *PetApiService) DeletePet(ctx context.Context, petId int64) (ImplResponse, error) {
...
func (s *PetApiService) GetPet(ctx context.Context, petId int64) (ImplResponse, error) {
	// TODO - update GetPet with the required logic for this service method.
	// Add api_pet_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetPet method not implemented")
}

// GetPetList - Get list of all pets
func (s *PetApiService) GetPetList(ctx context.Context) (ImplResponse, error) {
	// TODO - update GetPetList with the required logic for this service method.
	// Add api_pet_service.go to the .openapi-generator-ignore to avoid overwriting this service implementation when updating open api generation.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("GetPetList method not implemented")
}
